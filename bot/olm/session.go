...
// stolen from https://github.com/NotAFile/libolm-go/blob/master/account.go
// however that package wouldn't compile due to the "-" in the package name
...
func (s Session) MatchesInbound(one_time_key_message string) bool {
	one_time_key_message_buffer := []byte(one_time_key_message)
